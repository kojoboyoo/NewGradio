...
pipeline = load_pipeline(r"C:\Users\etnketiah\Documents\Azubi\New project\GradioLp\src\assets\ML\pipeline1.pkl")

# Load your RandomForestClassifier model separately
with open(r'src\assets\ML\random_forest_classifier.pkl', "rb") as file:
